    ...
    render() {
        return (
            <BubbleSlide previous="/device-orientation" next="/device-orientation-code">
                ...
                <Bubble>Should your device not have the right sensors, try opeing this page on your phone or tablet <a href="https://Live.BocaJS.org/device-orientation-code" alt="device orientation">https://Live.BocaJS.org/device-orientation-code</a>.</Bubble>
            </BubbleSlide>
        );
    }
};
