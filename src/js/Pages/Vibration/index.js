    ...
    renderSlide() {
        return (
            <BubbleSlide previous="/vibration" next="/vibration-code">
                ...
                <Bubble>Unfortunately this only works on devices with a vibration motor. Try opening this url on a phone: <a href="https://Meow.FloridaJS.com/vibration-example" title="Open this link on a mobile phone.">https://Meow.FloridaJS.com/vibration-example</a>.</Bubble>
            </BubbleSlide>
        );
    }
